...
public class PnTTKhach extends javax.swing.JPanel {
    ...
    public void chinhSuaTT(String dt, String ten, String gt){
        Connection connect=Code.KetNoi.layKetNoi();
        String sql="UPDATE HANH_KHACH SET DienThoai=?, HoTen=?, GioiTinh=? WHERE DienThoai='"+dienThoai+"'";
        try {
            PreparedStatement ps=connect.prepareStatement(sql);
            ps.setString(1, dt);
            ps.setString(2, ten);
    ...
    private boolean ktLoiNhapLieu(){
        boolean ktTen=false, ktGT=false;
        // KT Nhập họ tên
    ...
    private void initComponents() {
        ...
        btnDoiMK.setFont(new java.awt.Font("Tahoma", 1, 13)); // NOI18N
        ...
        if(btnChinhSua.getText().equals("Chỉnh sửa")){
            ...
            if(!ktLoiNhapLieu()){// kiểm tra các lỗi nhập 
                ...
                if(confirm==JOptionPane.OK_OPTION)// xác nhận == OK
                {
                    ...
                    chinhSuaTT(txtSDT1.getText(), txtHoTen1.getText(), gt);
